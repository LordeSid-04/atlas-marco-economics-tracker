...
export default function WorldPulse() {
  ...
  return (
    <div className="min-h-[calc(100vh-96px)] p-3 sm:p-4 lg:p-6">
      <div className="mx-auto max-w-[1680px] space-y-3">
        <section className="atlas-glass-strong rounded-2xl border border-cyan-400/20 px-4 py-4 sm:px-5">
        ...
        <section className="grid grid-cols-1 gap-3 xl:grid-cols-[320px_minmax(0,1fr)_390px]">
          <aside className="space-y-3">
            <div className="atlas-glass-strong rounded-2xl border border-white/[0.08] p-3">
          ...
          <section className="atlas-glass-strong rounded-2xl border border-white/[0.08] p-3.5">
          ...
          <aside className="space-y-3">
            <div className="atlas-glass-strong overflow-hidden rounded-2xl border border-white/[0.08] p-2.5">
