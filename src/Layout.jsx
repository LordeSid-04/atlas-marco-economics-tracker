...
import { BookOpenText, Globe, FlaskConical, Landmark, Menu, ShieldAlert, X } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { name: "Evidence", page: "EvidenceExplorer", icon: BookOpenText },
];
...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] relative">
      ...
      {/* Top Nav */}
      <nav className="atlas-top-nav fixed top-0 left-0 right-0 z-50">
          ...
          <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-20 sm:h-24">
              ...
              <Link to={createPageUrl("WorldPulse")} className="flex items-center gap-3 sm:gap-4 group">
                ...
                <span className="text-xl sm:text-2xl font-bold tracking-tight text-white leading-none">ATLAS</span>
                <span className="hidden sm:inline text-[11px] uppercase tracking-[0.24em] text-slate-400 leading-none">
                  Macro Intelligence
                </span>
              </Link>
